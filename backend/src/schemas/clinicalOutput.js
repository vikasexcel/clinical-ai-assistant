...
export const clinicalAssistantInsightsSchema = z.object({
  ...
  structuredNote: z.object({
    ...
    hpiElements: z.object({
      location: z.preprocess(v => v === false ? "not explicitly documented" : v, z.union([z.literal(true), z.literal("not explicitly documented")])),
      quality: z.preprocess(v => v === false ? "not explicitly documented" : v, z.union([z.literal(true), z.literal("not explicitly documented")])),
      severity: z.preprocess(v => v === false ? "not explicitly documented" : v, z.union([z.literal(true), z.literal("not explicitly documented")])),
      duration: z.preprocess(v => v === false ? "not explicitly documented" : v, z.union([z.literal(true), z.literal("not explicitly documented")])),
      modifyingFactors: z.preprocess(v => v === false ? "not explicitly documented" : v, z.union([z.literal(true), z.literal("not explicitly documented")])),
      associatedSignsSymptoms: z.preprocess(v => v === false ? "not explicitly documented" : v, z.union([z.literal(true), z.literal("not explicitly documented")])),
      timing: z.preprocess(v => v === false ? "not explicitly documented" : v, z.union([z.literal(true), z.literal("not explicitly documented")])),
      context: z.preprocess(v => v === false ? "not explicitly documented" : v, z.union([z.literal(true), z.literal("not explicitly documented")])),
    }),
